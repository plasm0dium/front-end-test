...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducers = _interopRequireWildcard(_app);
...
/***/ function(module, exports) {
	...
	var PRE_SIGN_IN = exports.PRE_SIGN_IN = "PRE_SIGN_IN";
	var POST_SIGN_IN = exports.POST_SIGN_IN = "POST_SIGN_IN";
	var SIGN_OUT = exports.SIGN_OUT = "SIGN_OUT";
	var ERROR = exports.ERROR = "ERROR";
	var MESSAGE_SUCCESS = exports.MESSAGE_SUCCESS = "MESSAGE_SUCCESS";
	var FETCH_MESSAGE_SUCCESS = exports.FETCH_MESSAGE_SUCCESS = "FETCH_MESSAGE_SUCCESS";
	var FETCH_STATES_ABBREVIATIONS = exports.FETCH_STATES_ABBREVIATIONS = "FETCH_STATES_ABBREVIATIONS";
	var POST_USER_SIGN_IN = exports.POST_USER_SIGN_IN = "POST_USER_SIGN_IN";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsCookie = __webpack_require__(217);

	var _jsCookie2 = _interopRequireDefault(_jsCookie);

	var _appActionCreators = __webpack_require__(218);

	var _signIn = __webpack_require__(219);
	...
	var _listStates = __webpack_require__(222);

	var _listStates2 = _interopRequireDefault(_listStates);
	...
	var Main = function (_React$Component) {
		...
		function Main(props) {
			...
			_this.state = { messages: [], listStates: [] };
			return _this;
		}
		...
		_createClass(Main, [{
			...
			value: function componentWillMount() {
				var _Cookies$get = _jsCookie2.default.get(),
				    login = _Cookies$get.login;
			...
			key: "_handleFetchMessages",
			value: function _handleFetchMessages() {
				var _this2 = this;

				_axios2.default.get("/read").then(function (response) {
					_this2.setState({
						messages: response.data
					});
					_this2.props.onFetchMessageSuccess();
				});
			}
		}, {
			key: "_handleFetchStates",
			value: function _handleFetchStates() {
				var _this3 = this;

				_axios2.default.get("/states/abbreviations").then(function (response) {
					_this3.setState({
						listStates: response.data
					});
					_this3.props.onFetchStatesAbbre();
				});
			}
		}, {
			key: "_handleLogOut",
			value: function _handleLogOut(evt) {
				...
				_axios2.default.get("/logout").then(function (response) {
					_this4.props.onSignOut(response);
				});
			}
		}, {
			key: "_renderListButton",
			value: function _renderListButton() {
				return _react2.default.createElement(
					"div",
					...
					_react2.default.createElement(
						"button",
						{
							...
							type: "button",
							onClick: this._handleFetchStates.bind(this) },
						"States"
					),
					_react2.default.createElement(
						"button",
						{
							className: "btn waves-effect waves-light",
							type: "button",
							onClick: this._handleFetchMessages.bind(this) },
						"Message"
					),
					_react2.default.createElement(
						"button",
			...
			key: "render",
			value: function render() {
				var _props$default = this.props.default,
				    preSignIn = _props$default.preSignIn,
				    postSignIn = _props$default.postSignIn,
				    message = _props$default.message,
				    listState = _props$default.listState,
				    messages = _props$default.messages;

				return _react2.default.createElement(
					"div",
					{ className: "app-component container" },
					preSignIn && _react2.default.createElement(_signIn2.default, null),
					postSignIn && this._renderListButton(),
					message && postSignIn && _react2.default.createElement(_message2.default, { message: messages || this.state.messages }),
					listState && postSignIn && _react2.default.createElement(_listStates2.default, { stateAbbre: this.state.listStates })
				);
			}
		}]);
	...
	var mapDispatchToProp = function mapDispatchToProp(dispatch, props) {
		return {
			onSignOut: function onSignOut(response) {
				return dispatch((0, _appActionCreators.onSignOut)(response));
			},
			onFetchMessageSuccess: function onFetchMessageSuccess() {
				return dispatch((0, _appActionCreators.onFetchMessageSuccess)());
			},
			postUserSignIn: function postUserSignIn() {
				return dispatch((0, _appActionCreators.postUserSignIn)());
			},
			onFetchStatesAbbre: function onFetchStatesAbbre() {
				return dispatch((0, _appActionCreators.onFetchStatesAbbre)());
			}
		};
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProp, mapDispatchToProp)(Main);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.onSignInError = onSignInError;
	exports.onSignOut = onSignOut;
	exports.onMessageSuccess = onMessageSuccess;
	exports.onFetchMessageSuccess = onFetchMessageSuccess;
	exports.postUserSignIn = postUserSignIn;
	exports.onFetchStatesAbbre = onFetchStatesAbbre;
	...
	function onFetchMessageSuccess() {
		return {
			type: actionTypes.FETCH_MESSAGE_SUCCESS
		};
	}

	function postUserSignIn() {
		return {
			type: actionTypes.POST_USER_SIGN_IN
		};
	}

	function onFetchStatesAbbre() {
		return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _alertMessage = __webpack_require__(220);
		...
		_createClass(SignIn, [{
			...
			value: function _handleSubmit(evt) {
				...
				_axios2.default.post("/login", {
					...
					_this2.props.postSignIn(response);
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						null,
						this.props.default.error && _react2.default.createElement(_alertMessage2.default, null)
					),
					_react2.default.createElement(
						"form",
						{
						...
						_react2.default.createElement(
							"input",
							{ type: this.state.show ? "text" : "password", placeholder: "Password", ref: "password" },
							_react2.default.createElement(
								"a",
								{
									href: "#",
	...
	SignIn.propTypes = {
		...
		postSignIn: _react2.default.PropTypes.func,
	...
	var mapDispatchToProp = function mapDispatchToProp(dispatch, props) {
		return {
			postSignIn: function postSignIn(response) {
				return dispatch((0, _appActionCreators.postSignIn)(response));
			},
			onError: function onError(error) {
				return dispatch((0, _appActionCreators.onSignInError)(error));
			}
		};
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProp, mapDispatchToProp)(SignIn);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AlertMessage = function AlertMessage() {
		return _react2.default.createElement(
			...
			"Your username and password do not match. Please check\n\t\t\tthe form and try again."
		);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Messages = function (_React$Component) {
		...
		_createClass(Messages, [{
			...
			value: function _handleSubmit(evt) {
				...
				evt.preventDefault();
				_axios2.default.post("/write", {
					phone: this.refs.phone.value,
					message: this.refs.message.value
				}).then(function (response) {
					_this2.props.onMessageSuccess(response);
				});
			...
			value: function _renderMessages() {
				var listMessage = this.props.message.map(function (obj) {
					var formatPhone = void 0;
					if (obj.phone) {
						formatPhone = obj.phone.replace(/[^\d]+/g, "").replace(/(\d{3})(\d{3})(\d{4})/, "$1-$2-$3");
					}
					return _react2.default.createElement(
						"div",
						{ key: formatPhone, className: "list-messages" },
						_react2.default.createElement(
							"label",
							{ className: "user" },
							obj.user
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					{ className: "row message-component" },
					_react2.default.createElement(
						"form",
						{
							onSubmit: this._handleSubmit.bind(this),
							method: "post",
							className: "col s6" },
						_react2.default.createElement("input", { type: "text", placeholder: "Phone 000-000-0000", ref: "phone" }),
	...
	var mapDispatchToProp = function mapDispatchToProp(dispatch, props) {
		return {
			onMessageSuccess: function onMessageSuccess(response) {
				return dispatch((0, _appActionCreators.onMessageSuccess)(response));
			}
		};
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProp, mapDispatchToProp)(Messages);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListStates = function (_React$Component) {
		_inherits(ListStates, _React$Component);

		function ListStates(props) {
			_classCallCheck(this, ListStates);

			var _this = _possibleConstructorReturn(this, (ListStates.__proto__ || Object.getPrototypeOf(ListStates)).call(this, props));

			_this.state = { stateDetail: {}, show: false };
			return _this;
		}

		_createClass(ListStates, [{
			key: "_handleSingleState",
			value: function _handleSingleState(item, evt) {
				var _this2 = this;

				evt.preventDefault();
				_axios2.default.get("/states/" + item).then(function (response) {
					_this2.setState({
			...
			key: "_renderStatesList",
			value: function _renderStatesList() {
				var _this3 = this;

				return this.props.stateAbbre.map(function (abb) {
					return _react2.default.createElement(
						"a",
						{ href: "#", key: abb, onClick: _this3._handleSingleState.bind(_this3, abb) },
						abb
					);
				});
			}
		}, {
			key: "_renderStateDetails",
			value: function _renderStateDetails() {
				var stateDetail = this.state.stateDetail;

				return Object.keys(stateDetail).map(function (list) {
					return _react2.default.createElement(
						"div",
						{ className: "row", key: list },
						_react2.default.createElement(
							"div",
							{ className: "col s6" },
							list
